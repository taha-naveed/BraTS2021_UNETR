...
parser.add_argument("--data_dir", default="/content/drive/MyDrive/BraTS_TrainDataset", type=str, help="dataset directory")
parser.add_argument("--json_list", default="/content/dataset_metadata.json", type=str, help="dataset json file")
parser.add_argument(
...
def main_worker(gpu, args):
    ...
    dice_loss = DiceCELoss(
        to_onehot_y=False, softmax=True, squared_pred=True, smooth_nr=args.smooth_nr, smooth_dr=args.smooth_dr
    )
